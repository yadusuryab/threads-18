...
const VALUES = [
  {
    ...
    body: "Every sneakers we carry is chosen for real life — durable, versatile, and worth wearing every single day.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" className="w-6 h-6">
      ...
      <div className="about-page">
        ...
        <section className="relative flex flex-col items-center justify-center text-center
          ...
          <div className="fade-up relative mb-10">
            <div className="brand-ring w-24 h-24 md:w-28 md:h-28 mx-auto shadow-[0_0_60px_rgba(20,184,154,0.2)]">
              <div className="brand-ring-inner">
                <span className="serif text-white text-2xl md:text-3xl font-light tracking-wider">threads_eighteen</span>
              </div>
            </div>
          </div>
          ...
          <p className="fade-up delay-3 mt-7 text-[var(--muted)] text-sm md:text-base
            ...
            We believe great design should be accessible. threads_eighteen brings you carefully
            curated timepieces and gadgets — built for life, priced for everyone.
          </p>
          ...
          <div className="fade-up delay-4 flex items-center gap-3 mt-10 flex-wrap justify-center">
            ...
            <a href="https://instagram.com/threads_eighteen_online" target="_blank" rel="noopener noreferrer"
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="serif text-[clamp(2rem,5vw,3.2rem)] font-light leading-[1.05] text-white mb-6">
                Started with a passion<br />for great watches.
              </h2>
              <div className="space-y-4 text-[var(--muted)] text-sm leading-relaxed font-light">
                <p>
                  threads_eighteen started as a simple idea: premium watches shouldn't cost a fortune,
                ...
                <p>
                  Based in Kerala, shipping across India. COD available. Fast replies, always.
                </p>
              </div>
              {/* Contact pill */}
            ...
            <div className="relative">
              <div className="glass rounded-3xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="relative space-y-6">
                  {[
                    { label: "Category", value: "Watches & Gadgets" },
                    { label: "Location", value: "Kerala, India" },
                    { label: "Payment", value: "COD & Online" },
                    { label: "Shipping", value: "Pan India" },
                    { label: "Instagram", value: "@threads_eighteen_online" },
                    { label: "WhatsApp", value: "+91 94009 41277" },
                  ].map((item, i) => (
          ...
          <div className="max-w-3xl mx-auto glass rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="serif text-[clamp(2rem,6vw,4rem)] font-light text-white leading-tight mb-6">
                Find your next<br />favourite watch.
              </h2>
