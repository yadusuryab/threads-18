...
export default function MarqueeStrip() {
  return (
    <>
      ...
      <div className="w-full border-y  bg-[#c2b06b] overflow-hidden py-2.5 select-none">
        <div className="flex items-center whitespace-nowrap marquee-track">
          {items.map((text, i) => (
            <React.Fragment key={i}>
              <span className="text-lg tracking-tighter text-[#1f2e11] font-bold italic font-serif  flex-shrink-0">
                {text}
              </span>
              <Dot />
            </React.Fragment>
